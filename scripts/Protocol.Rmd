...
#nr <- nrow(brca2)
#row2.train <- sample(nr, floor(0.5 * nr))
#brca2.votes.train <- brca2[row2.train,]
#brca2.votes.test <- brca2[-row2.train,]


#nr <- nrow(brca1)
#row1.train <- sample(nr, floor(0.5 * nr))
#brca1.votes.train <- brca1[row1.train,]
#brca1.votes.test <- brca1[-row1.train,]
...
#brca2.votes.train <- subset(brca2,set_=='test')
#brca1.votes.train <- subset(brca1,set_=='test')
#brca2.votes.test <- subset(brca2,set_=='train')
#brca1.votes.test <- subset(brca1,set_=='train')

brca2.votes.train <- brca2
brca1.votes.train <- brca1
brca2.votes.test <- brca2
brca1.votes.test <- brca1
...
cutoff[i,1] <- v1a.sum.i$SpEqualSe[[1]]$optimal.cutoff$cutoff[[1]]
...
roc2a.nvm <- prediction(brca2.votes.train$sum_del_6,brca2.votes.train$hdr_del)
...
roc2b.nvm <- prediction(brca2.votes.train$sum_nn_7,brca2.votes.train$hdr_not_neutral)
...
roc1a.nvm <- prediction(brca1.votes.train$sum_del_13,brca1.votes.train$hdr_del)
...
roc1b.nvm <- prediction(brca1.votes.train$sum_nn_9,brca1.votes.train$hdr_not_neutral)
...
```{r}
knitr::kable(ST4)
write.csv(ST4,file='TableS4.csv')
```
