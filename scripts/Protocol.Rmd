...
v2a.42 <- optimal.cutpoints(X="sum_del_4",status="hdr_del",
                            tag.healthy=0,methods=c("SpEqualSe"),
					                  control = control.cutpoints(ci.SeSp = "AgrestiCoull"),
...
v2b.42 <- optimal.cutpoints(X="sum_nn_3",status="hdr_not_neutral",
                            tag.healthy=0,methods=c("SpEqualSe"),
					                  control = control.cutpoints(ci.SeSp = "AgrestiCoull"),
					                  ci.fit=TRUE,data=brca2.votes.train)
...
v1a.42 <- optimal.cutpoints(X="sum_del_3",status="hdr_del",
                            tag.healthy=0,methods=c("SpEqualSe"),
					                  control = control.cutpoints(ci.SeSp = "AgrestiCoull"),
